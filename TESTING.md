...
| Suite                                      | Covers                                                                                                               |
| ------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| `LumoraWrapper.test.tsx`                   | Rendering, brand, user menu and dark mode, search slot, Nexa button, sidebar links, chat panel, notifications drawer |
| `LumoraWrapper.session.test.tsx`           | Session gate and redirect, `onVerify`, token check on mount, logout                                                  |
| `LumoraWrapper.responsive.test.tsx`        | Desktop vs mobile, all three sidebar variants, widths, sidebar order, collapsed search                               |
| `LumoraWrapper.accessibility.test.tsx`     | Landmarks, accessible names, keyboard access to the user menu                                                        |
| `CollapsibleSidebar.test.tsx`              | Collapse state and persistence, nesting, colors, header brand, search/footer slots                                   |
