...
| `onBrandClick` | `function` | -             | Makes the brand block (app name + logo) clickable, in the navbar and in the expanded collapsible sidebar header. Typical use: go to the landing page |
...
| `sidebarVariant`               | `'rail' \| 'collapsible' \| 'rail-labeled'` | `'rail'`                    | Desktop sidebar layout. `'rail'` is the fixed icon rail; `'collapsible'` is a full-height panel with its own 60px header (hamburger toggle + brand) that switches between an expanded icon+label list and a collapsed icon rail (persisted to localStorage) — the brand lives in the sidebar header while expanded and moves to the navbar while collapsed; `'rail-labeled'` is a fixed narrow rail with the label stacked under each icon that never collapses (no toggle). Mobile is unaffected. |
| `showSidebarRailTitles`        | `boolean`                                   | `false`                     | For the `'rail'` variant only: show `link.text` as a caption under each icon (rail width is unchanged).                                                                                                                                                                                                                                                                                                                                                                                            |
| `sidebarBackgroundColor`       | `string`                                    | `'#ffffff'` / theme paper   | Surface background of the collapsible sidebar.                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `sidebarHeaderBackgroundColor` | `string`                                    | sidebar surface             | Background of the collapsible sidebar's 60px header block (hamburger + brand).                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `accentColor`                  | `string`                                    | `'#01584f'`                 | Brand accent used by the navbar (app name / logo / menu button) and as the default for the sidebar accent.                                                                                                                                                                                                                                                                                                                                                                                         |
| `sidebarAccentColor`           | `string`                                    | `accentColor`               | Accent for the sidebar — the solid fill of the highlighted item, shared by the active item **and** any item on hover. Independent of the navbar brand accent.                                                                                                                                                                                                                                                                                                                                      |
| `sidebarForegroundColor`       | `string`                                    | sidebar accent / theme text | Idle (inactive) text/icon color for sidebar items, independent of the highlight fill. Lets idle labels be tinted (e.g. light teal) while the highlighted item uses a darker solid fill.                                                                                                                                                                                                                                                                                                            |
| `activeSidebarForegroundColor` | `string`                                    | auto-contrast               | Text/icon color of the highlighted sidebar item (active **and** hover). Defaults to an auto-contrasting color from the sidebar accent.                                                                                                                                                                                                                                                                                                                                                             |
